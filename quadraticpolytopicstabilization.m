...
for i=1:1:7
AAi=[-a4t(i) 1 -a5t(i);((-ap1t(i)*a4t(i))-a2t(i)) (ap1t(i)-a1t(i)) ((-ap1t(i)*a5t(i))-a3t(i));0 0 -(1/tau_z)];
BBi = (wx/57.3)*[-1 0 0;-ap1t(i) Jxyz 0; 0 0 1];
end
options=sdpsettings('solver','sedumi');

F=[F;AAi*P+P*(AAi)'+BBi*Z+Z'*BBi' <tol*eye(3)];
optimize(F);
PP=value(P)
ZZ=value(Z)
%Deriving Controller
